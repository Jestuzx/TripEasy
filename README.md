# Hello everyone! Welcome to EasyTrip!
...
### Then for initialization server write ```uvicorn main:app --reload``` and ``` Ctrl + C for stop server ``` more info how to use uvicorn you can find in the official website https://www.uvicorn.org/ 
